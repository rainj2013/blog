...
![MCP Server 在 Cursor 中返回 Mermaid 渲染结果](/static/2025-07-12/mcp-mermaid-cursor.png)
...
![Cursor 扫描 MCP resource 类型服务](/static/2025-07-12/mcp-resource-cursor.png)
...
![Cherry Studio 扫描 MCP resource 类型服务](/static/2025-07-12/mcp-resource-cherry-studio.png)
...
![高德地图和 MiniMax MCP Server 组合案例](/static/2025-07-12/mcp-gaode-minimax-demo.png)
...
![MCP Host 工具上下文示例](/static/2025-07-12/mcp-host-tools-context.png)

3. MCP Client会根据MCP Server声明的接收参数格式要求，结合内置系统级的prompt来调用大模型组装请求参数。所以写好MCP Server中的这些Schema声明很重要。
![MCP Client 参数 Schema 示例](/static/2025-07-12/mcp-client-schema.png)
