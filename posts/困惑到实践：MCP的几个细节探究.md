...
##### 使用效果
在Cursor中连接这个MCP 在Cursor中连接这个MCP Server，输入prompt用mermaid画图时，Cursor本身内置的工具足够强大，生成的mermaid脚本默认直接用内置的工具渲染出来了。
...
![image.png](https://note.youdao.com/yws/res/1094/WEBRESOURCE7f7e3593df76f0685bc7d8d8b8f06c92)
...
![image.png](https://note.youdao.com/yws/res/1137/WEBRESOURCEa40704ae034713f4869d86635c3860c5)
...
![image.png](https://note.youdao.com/yws/res/1130/WEBRESOURCE25b09932f13ecb9cdde7ba3a688c3efc)
...
![image.png](https://note.youdao.com/yws/res/1210/WEBRESOURCE247b3d51e46a58d74e244f989d3ccb11)
...
![image.png](https://note.youdao.com/yws/res/1157/WEBRESOURCE9e4660775c63fd00dc7d67ec8991b590)

3. MCP Client会根据MCP Server声明的接收参数格式要求，结合内置系统级的prompt来调用大模型组装请求参数。所以写好MCP Server中的这些Schema声明很重要。
![image.png](https://note.youdao.com/yws/res/1180/WEBRESOURCE1acec47ab9571ecf2c69ba0878b022f0)
