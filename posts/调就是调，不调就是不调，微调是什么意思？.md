...
![萌娘百科 HTML 数据示例](/static/2025-09-30/finetune-moegirl-html.png)
...
![QLoRA 微调训练过程](/static/2025-09-30/finetune-qlora-training.png)

#### 推理验证

训练完成后，推理验证一下效果：
![微调后推理验证结果](/static/2025-09-30/finetune-inference-result.png)
