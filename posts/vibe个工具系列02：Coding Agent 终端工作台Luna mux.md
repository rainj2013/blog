---
title: "vibe 个工具系列 02｜Coding Agent 终端工作台 Luna mux"
date: 2026-08-20
tag: AI工程
...
SSH 和 SFTP 这部分是我的另一个工具软件 [Luna Remote](https://github.com/rainj2013/luna-remote) 移植过来的，密码、私钥、SSH Agent、Host Key 校验、保活、一级跳板机，以及 SFTP 和本地/远程/SOCKS5 转发，能力基本一致。
