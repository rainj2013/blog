...
│ 📈 Ward                               美股交易中     │
├──────────┬──────────┬──────────┬──────────────────┤
│ Nasdaq  +0.40%    │ Dow      +0.44%    │ S&P 500  +0.25%    │ 黄金   -0.33%  │
│ 24,502  │ 49,658   │ 7,126    │ 4,790           │
│ 开盘 +0.40% │ 开盘 +0.44% │ 开盘 +0.25% │ 开盘 -0.32%   │
│ [🧠AI][📊K] │ [🧠AI][📊K] │ [🧠AI][📊K] │ [🧠AI][📊K]  │
├─────────────────────────────────────────────────────┤
│ 🕐 盘前 / 盘中 / 盘后  来源：ETF（QQQ/SPY/DIA）     │
│ Nasdaq  盘前648.34(+0.24%) 盘中649.33(+0.39%) 盘后-- │
│ S&P 500 盘前710.16(+0.20%) 盘中710.25(+0.22%) 盘后-- │
│ Dow     盘前496.65(+0.47%) 盘中496.45(+0.43%) 盘后-- │
└─────────────────────────────────────────────────────┘
```
...
│ Nasdaq 综合 K线                               [✕]  │
├─────────────────────────────────────────────────────┤
│  [K 线图主体 - 橙红色 K 线，均线 MA5/MA20/MA60]    │
│                                                     │
│  均线：MA5(黄)  MA20(紫)  MA60(蓝)                  │
└─────────────────────────────────────────────────────┘
```
...
├─────────────────────────────────────────────────────┤
│ 一、今日行情概述                                     │
│ 2026年4月21日，美股市场整体呈现小幅上涨态势...       │
│                                                     │
│ 二、主要指数表现                                     │
│ 指数           涨跌幅    当前点位                   │
│ Nasdaq Composite +0.37%  24,495.21                │
│ Nasdaq 100      +0.36%  26,686.67                │
│ S&P 500         +0.25%   7,126.83                  │
│ Dow Jones       +0.47%  49,674.30                 │
│                                                     │
│ 三、技术面分析                                       │
│ 均线位置：收盘价24,495.21，处于日内中轴上方...     │
│ 支撑位：24,395 / 24,350    压力位：24,538 / 24,600 │
│ 成交量：27.24亿股，量价配合健康                     │
│                                                     │
│ 四、市场情绪判断                                     │
│ 情绪评分：6/9（偏向乐观但保持谨慎）                  │
│ 核心议题：AI/半导体财报、苹果CEO更替、地缘政治      │
│ ...                                                 │
└─────────────────────────────────────────────────────┘
```
